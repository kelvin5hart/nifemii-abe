    ...
    const addToCart = (product, size, quantity = 1)=>{
        ...
        setItems((currentItems)=>{
            ...
            if (existingItemIndex > -1) {
                ...
                const newQuantity = Math.min(updatedItems[existingItemIndex].quantity + quantity, maxStock);
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyAmJ53W4OJp6xbJ-QHVAaBbJg4EQLdbIh4"),
    authDomain: ("TURBOPACK compile-time value", "nifemii-abe-689cd.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "nifemii-abe-689cd"),
    storageBucket: ("TURBOPACK compile-time value", "nifemii-abe-689cd.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "430817811311"),
    appId: ("TURBOPACK compile-time value", "1:430817811311:web:33e9e78812dbc457f9a69a"),
    measurementId: ("TURBOPACK compile-time value", "G-SFVS5YF9HY")
};
...
async function sendOTP(phone) {
    try {
        ...
        return {
            ...
            testCode: ("TURBOPACK compile-time truthy", 1) ? code : "TURBOPACK unreachable"
        };
    } catch (error) {
...
function AuthProvider({ children }) {
    ...
    const [manualAuthInProgress, setManualAuthInProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const checkHasPassword = async (phoneNumber)=>{
        const formattedPhone = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$otp$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPhoneNumber"])(phoneNumber);
        const usersQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "users"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])("phone", "==", formattedPhone));
        const existingUsers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(usersQuery);
        if (existingUsers.empty) {
    ...
    const loginWithPassword = async (phoneNumber, password)=>{
        ...
        try {
            ...
            if (!userData.hasPassword || !userData.passwordHash) {
                return {
                    success: false,
                    message: "Password not set. Please use OTP to login."
                };
            }
...
_s(AuthProvider, "NGcDNcEH3INpHz9NTOxtJkVoqPw=");
_c = AuthProvider;
function useAuth() {
    _s1();
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    ...
                                                                    className: `px-2 py-1 transition-colors ${item.quantity >= item.maxStock ? "text-[#444444] cursor-not-allowed" : "text-[#888888] hover:text-[#f5f5f5]"}`,
                                                                    children: "+"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/CartDrawer.tsx",
                                                                    lineNumber: 133,
                                                ...
                                                item.quantity >= item.maxStock && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-[10px] text-[#c9a962] font-[family-name:var(--font-montserrat)] mt-1",
                                                    children: [
                                                        "Max available: ",
                                                        item.maxStock
                                                    ]
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: [
                                    ...
                                    user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "absolute -top-1 -right-1 bg-green-500 w-2 h-2 rounded-full"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Navbar.tsx",
                                        lineNumber: 94,
                                        columnNumber: 15
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: [
                                    ...
                                    itemCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "absolute -top-2 -right-2 bg-[#c9a962] text-[#0a0a0a] text-xs w-4 h-4 rounded-full flex items-center justify-center font-[family-name:var(--font-montserrat)] text-[10px]",
                                        children: itemCount
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Navbar.tsx",
                                        lineNumber: 171,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            href: user ? "/account" : "/account/login",
                            className: `text-lg tracking-[0.15em] transition-colors duration-300 font-[family-name:var(--font-montserrat)] uppercase ${pathname.startsWith("/account") ? "text-[#c9a962]" : "text-[#888888] hover:text-[#c9a962]"}`,
                            onClick: ()=>setIsMobileMenuOpen(false),
...
_s(Navbar, "SOW122h+6woaHXhDYkQ5JlDMRwY=", false, function() {
    return [
...
//# sourceMappingURL=src_edd3277f._.js.map