...
function CustomerAppointmentsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomerAppointmentsPage.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(appointmentsQuery, {
                "CustomerAppointmentsPage.useEffect.unsubscribe": (snapshot)=>{
                    const appointmentsData = snapshot.docs.map({
                        "CustomerAppointmentsPage.useEffect.unsubscribe.appointmentsData": (doc)=>{
                            const data = doc.data();
                            return {
                                id: doc.id,
                                ...data,
            ...
            const fetchSettings = {
                "CustomerAppointmentsPage.useEffect.fetchSettings": async ()=>{
                    try {
            ...
            }["CustomerAppointmentsPage.useEffect.fetchSettings"];
            fetchSettings();
            return ({
                "CustomerAppointmentsPage.useEffect": ()=>unsubscribe()
            })["CustomerAppointmentsPage.useEffect"];
                                    ...
                                    bookingDate && isDateAvailable(bookingDate) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: generateTimeSlots().map((slot)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>setBookingTime(slot),
                                                        className: `py-2 text-sm border font-[family-name:var(--font-montserrat)] transition-colors ${bookingTime === slot ? "border-[#c9a962] text-[#c9a962] bg-[#c9a962]/10" : "border-[#2a2a2a] text-[#888888] hover:border-[#3a3a3a]"}`,
                                                        children: slot
                                                    }, slot, false, {
                                                        fileName: "[project]/src/app/account/appointments/page.tsx",
                                                        lineNumber: 403,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                disabled: saving || !bookingDate || !bookingTime || !isDateAvailable(bookingDate),
...
_s(CustomerAppointmentsPage, "WdYa7BZ2Rp3fetobHGWEGOKvADA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_e7ee67d4._.js.map