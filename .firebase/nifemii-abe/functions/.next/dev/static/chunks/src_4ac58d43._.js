...
function AuthProvider({ children }) {
    ...
    const sendOTP = async (phoneNumber)=>{
        ...
        // Initialize fresh reCAPTCHA verifier
        const verifier = await initRecaptcha();
        if (!verifier) throw new Error("reCAPTCHA not initialized");
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithPhoneNumber"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], formattedPhone, verifier);
...
_s(AuthProvider, "kF840FtbVz7yglFVEwbA84R2WjA=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=src_4ac58d43._.js.map